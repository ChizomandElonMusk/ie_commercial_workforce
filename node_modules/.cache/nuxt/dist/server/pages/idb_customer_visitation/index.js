...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_117637d6_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(91);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_117637d6_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_117637d6_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_117637d6_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_117637d6_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, "#sig-canvas[data-v-117637d6]{border:2px dotted #ccc;border-radius:15px;cursor:crosshair}", ""]);
// Exports
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/idb_customer_visitation/index.vue?vue&type=template&id=117637d6&scoped=true
var render = function render() {
  ...
  }, [_vm._ssrNode("<div class=\"row\" data-v-117637d6>", "</div>", [_vm._ssrNode("<div class=\"col s12\" data-v-117637d6>", "</div>", [_c('nuxt-link', {
    staticClass: "red white-text btn",
    attrs: {
      "to": "../dashboard_ie_force"
    }
  }, [_vm._v("\n                Back\n            ")]), _vm._ssrNode(" <b class=\"grey-text btn disabled\" style=\"font-size: 10px;\" data-v-117637d6> IDB Customer Visitation</b>")], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"row\" data-v-117637d6>", "</div>", [_vm._ssrNode("<div class=\"row\" data-v-117637d6><div class=\"col s12\" data-v-117637d6><div" + _vm._ssrClass("row", {
    'hide': _vm.hideModal
  }) + " data-v-117637d6><div class=\"row\" data-v-117637d6><a href=\"#!\" class=\"waves-effect waves-red btn-large white red-text right\" data-v-117637d6>DONE</a></div> <div class=\"row\" data-v-117637d6><div class=\"container\" data-v-117637d6><div class=\"row\" data-v-117637d6><div class=\"col s12 center\" data-v-117637d6><h6 data-v-117637d6>Sign here!</h6></div></div> <div class=\"row\" data-v-117637d6><div class=\"col s12 center\" data-v-117637d6><canvas id=\"sig-canvas\" width=\"250px\" data-v-117637d6>\n                                        Your phone not supporting signature\n                                    </canvas></div></div> <div class=\"row\" data-v-117637d6><div class=\"col s12 center\" data-v-117637d6><div class=\"col s6\" data-v-117637d6><button id=\"sig-submitBtn\" class=\"btn btn-large red\" data-v-117637d6>Save</button></div> <div class=\"col s6\" data-v-117637d6><button id=\"sig-clearBtn\" class=\"btn btn-large red\" data-v-117637d6>Clear</button></div></div></div> <br data-v-117637d6> <div class=\"row\" data-v-117637d6><div class=\"col s12\" data-v-117637d6><textarea id=\"sig-dataUrl\" rows=\"5\" class=\"form-control hide\" data-v-117637d6>Data URL for your signature will go here!</textarea></div></div></div></div></div></div></div> "), _vm._ssrNode("<div" + _vm._ssrClass("row", {
    'hide': _vm.hideForm
  }) + " data-v-117637d6>", "</div>", [_vm._ssrNode("<div class=\"col s12\" data-v-117637d6>", "</div>", [_vm._ssrNode("<form style=\"margin-top: 20px\" data-v-117637d6>", "</form>", [_vm._ssrNode("<div class=\"row\" data-v-117637d6>", "</div>", [_vm._ssrNode("<div class=\"col s12\" style=\"margin-bottom: 15px;\" data-v-117637d6>", "</div>", [_c('CustomSelect', {
    attrs: {
      "options": ['prepaid'],
      "default": 'prepaid'
    },
  ...
  })], 1)]), _vm._ssrNode(" " + (_vm.service_type == 'postpaid' ? "<div class=\"row\" data-v-117637d6><div class=\"col s9\" data-v-117637d6><input type=\"text\" placeholder=\"Account number\"" + _vm._ssrAttr("value", _vm.account_number) + " data-v-117637d6></div> <div class=\"col s3\" data-v-117637d6><button class=\"btn btn-flat red white-text\" data-v-117637d6>Check</button></div></div>" : "<!---->") + " " + (_vm.service_type == 'prepaid' ? "<div class=\"row\" data-v-117637d6><div class=\"col s9\" data-v-117637d6><input type=\"text\" placeholder=\"Meter number\"" + _vm._ssrAttr("value", _vm.meter_number) + " data-v-117637d6></div> <div class=\"col s3\" data-v-117637d6><button class=\"btn btn-flat red white-text\" data-v-117637d6>Check</button></div></div>" : "<!---->") + " <div class=\"row\" data-v-117637d6><div class=\"col s12\" data-v-117637d6><input type=\"text\" placeholder=\"Account type\" disabled=\"disabled\"" + _vm._ssrAttr("value", _vm.account_type) + " data-v-117637d6></div></div> <div class=\"row\" data-v-117637d6><div class=\"col s12\" data-v-117637d6><input type=\"text\" placeholder=\"Account name\" disabled=\"disabled\"" + _vm._ssrAttr("value", _vm.account_name) + " data-v-117637d6></div></div> <div class=\"row\" data-v-117637d6><div class=\"col s12\" data-v-117637d6><input type=\"text\" placeholder=\"Tarrif\" disabled=\"disabled\"" + _vm._ssrAttr("value", _vm.tarrif) + " data-v-117637d6></div></div> <div class=\"row\" data-v-117637d6><div class=\"col s12\" data-v-117637d6><input type=\"text\" placeholder=\"Address\" disabled=\"disabled\"" + _vm._ssrAttr("value", _vm.address) + " data-v-117637d6></div></div> <div class=\"row\" data-v-117637d6><div class=\"col s12\" data-v-117637d6><b data-v-117637d6>BU:</b>" + _vm._ssrEscape(" " + _vm._s(_vm.business_unit) + "\n                            ") + "</div></div> <br data-v-117637d6> <div class=\"row\" data-v-117637d6><div class=\"col s12\" data-v-117637d6><b data-v-117637d6>UT:</b>" + _vm._ssrEscape(" " + _vm._s(_vm.undertaking_one) + "\n                        ") + "</div></div> <div class=\"row\" data-v-117637d6><div class=\"col s12\" data-v-117637d6><input type=\"text\" placeholder=\"DT name\" disabled=\"disabled\"" + _vm._ssrAttr("value", _vm.dt_name) + " data-v-117637d6></div></div> <div class=\"row\" data-v-117637d6><div class=\"col s12\" data-v-117637d6><input type=\"text\" placeholder=\"Phone number\"" + _vm._ssrAttr("value", _vm.phone_number) + " data-v-117637d6></div></div> <div class=\"row\" data-v-117637d6><div class=\"col s12\" data-v-117637d6><input type=\"text\" placeholder=\"Location\" disabled=\"disabled\"" + _vm._ssrAttr("value", _vm.location) + " data-v-117637d6></div></div> <div class=\"row\" data-v-117637d6><div class=\"col s12\" data-v-117637d6><input type=\"text\" placeholder=\"IDB Box Number\" disabled=\"disabled\"" + _vm._ssrAttr("value", _vm.idb_box_number) + " data-v-117637d6></div></div> <div class=\"row\" data-v-117637d6><div class=\"col s12\" data-v-117637d6><input type=\"text\" placeholder=\"DCU Number\" disabled=\"disabled\"" + _vm._ssrAttr("value", _vm.idb_dcu_number) + " data-v-117637d6></div></div> <div class=\"row\" data-v-117637d6><div class=\"col s12\" data-v-117637d6><input type=\"text\" placeholder=\"IDB Pole Number\"" + _vm._ssrAttr("value", _vm.idb_pole_number) + " data-v-117637d6></div></div> <div class=\"row center\" data-v-117637d6><div class=\"col s12\" data-v-117637d6><b data-v-117637d6>\n                                Is IDB installed?\n                            </b></div> <form data-v-117637d6><div class=\"col s4\" data-v-117637d6><button class=\"btn btn-small green\" data-v-117637d6>Yes</button></div> <div class=\"col s4\" data-v-117637d6>" + (_vm.is_idb_installed == 'Yes' ? "<b class=\"green-text\" data-v-117637d6>Yes</b>" : "<!---->") + " " + (_vm.is_idb_installed == 'No' ? "<b class=\"red-text\" data-v-117637d6>No</b>" : "<!---->") + " " + (_vm.is_idb_installed == '' ? "<b class=\"red-text\" data-v-117637d6>--</b>" : "<!---->") + "</div> <div class=\"col s4\" data-v-117637d6><button class=\"btn btn-small red\" data-v-117637d6>No</button></div></form></div> <br data-v-117637d6> <div class=\"row center\" data-v-117637d6><div class=\"col s12\" data-v-117637d6><b data-v-117637d6>\n                                Is IDB safely secured?\n                            </b></div> <form data-v-117637d6><div class=\"col s4\" data-v-117637d6><button class=\"btn btn-small green\" data-v-117637d6>Yes</button></div> <div class=\"col s4\" data-v-117637d6>" + (_vm.is_idb_safely_secured == 'Yes' ? "<b class=\"green-text\" data-v-117637d6>Yes</b>" : "<!---->") + " " + (_vm.is_idb_safely_secured == 'No' ? "<b class=\"red-text\" data-v-117637d6>No</b>" : "<!---->") + " " + (_vm.is_idb_safely_secured == '' ? "<b class=\"red-text\" data-v-117637d6>--</b>" : "<!---->") + "</div> <div class=\"col s4\" data-v-117637d6><button class=\"btn btn-small red\" data-v-117637d6>No</button></div></form></div> <br data-v-117637d6> <div class=\"row center\" data-v-117637d6><div class=\"col s12\" data-v-117637d6><b data-v-117637d6>\n                                Is Supply Cable Trunked?\n                            </b></div> <form data-v-117637d6><div class=\"col s4\" data-v-117637d6><button class=\"btn btn-small green\" data-v-117637d6>Yes</button></div> <div class=\"col s4\" data-v-117637d6>" + (_vm.is_supply_cable_trunked == 'Yes' ? "<b class=\"green-text\" data-v-117637d6>Yes</b>" : "<!---->") + " " + (_vm.is_supply_cable_trunked == 'No' ? "<b class=\"red-text\" data-v-117637d6>No</b>" : "<!---->") + " " + (_vm.is_supply_cable_trunked == '' ? "<b class=\"red-text\" data-v-117637d6>--</b>" : "<!---->") + "</div> <div class=\"col s4\" data-v-117637d6><button class=\"btn btn-small red\" data-v-117637d6>No</button></div></form></div> <br data-v-117637d6> <div class=\"row center\" data-v-117637d6><div class=\"col s12\" data-v-117637d6><b data-v-117637d6>\n                                Is IDB box functioning?\n                            </b></div> <form data-v-117637d6><div class=\"col s4\" data-v-117637d6><button class=\"btn btn-small green\" data-v-117637d6>Yes</button></div> <div class=\"col s4\" data-v-117637d6>" + (_vm.is_idb_box_functioning == 'Yes' ? "<b class=\"green-text\" data-v-117637d6>Yes</b>" : "<!---->") + " " + (_vm.is_idb_box_functioning == 'No' ? "<b class=\"red-text\" data-v-117637d6>No</b>" : "<!---->") + " " + (_vm.is_idb_box_functioning == '' ? "<b class=\"red-text\" data-v-117637d6>--</b>" : "<!---->") + "</div> <div class=\"col s4\" data-v-117637d6><button class=\"btn btn-small red\" data-v-117637d6>No</button></div></form></div> <br data-v-117637d6> <div class=\"row center\" data-v-117637d6><div class=\"col s12\" data-v-117637d6><b data-v-117637d6>\n                                Is supply cable neat?\n                            </b></div> <form data-v-117637d6><div class=\"col s4\" data-v-117637d6><button class=\"btn btn-small green\" data-v-117637d6>Yes</button></div> <div class=\"col s4\" data-v-117637d6>" + (_vm.is_supply_cable_neat == 'Yes' ? "<b class=\"green-text\" data-v-117637d6>Yes</b>" : "<!---->") + " " + (_vm.is_supply_cable_neat == 'No' ? "<b class=\"red-text\" data-v-117637d6>No</b>" : "<!---->") + " " + (_vm.is_supply_cable_neat == '' ? "<b class=\"red-text\" data-v-117637d6>--</b>" : "<!---->") + "</div> <div class=\"col s4\" data-v-117637d6><button class=\"btn btn-small red\" data-v-117637d6>No</button></div></form></div> <br data-v-117637d6> <div class=\"row center\" data-v-117637d6><div class=\"col s12\" data-v-117637d6><b data-v-117637d6>\n                                Is meter connected?\n                            </b></div> <form data-v-117637d6><div class=\"col s4\" data-v-117637d6><button class=\"btn btn-small green\" data-v-117637d6>Yes</button></div> <div class=\"col s4\" data-v-117637d6>" + (_vm.is_meter_connected == 'Yes' ? "<b class=\"green-text\" data-v-117637d6>Yes</b>" : "<!---->") + " " + (_vm.is_meter_connected == 'No' ? "<b class=\"red-text\" data-v-117637d6>No</b>" : "<!---->") + " " + (_vm.is_meter_connected == '' ? "<b class=\"red-text\" data-v-117637d6>--</b>" : "<!---->") + "</div> <div class=\"col s4\" data-v-117637d6><button class=\"btn btn-small red\" data-v-117637d6>No</button></div></form></div> <br data-v-117637d6> <div class=\"row center\" data-v-117637d6><div class=\"col s12\" data-v-117637d6><b data-v-117637d6>\n                                Is meter infraction?\n                            </b></div> <form data-v-117637d6><div class=\"col s4\" data-v-117637d6><button class=\"btn btn-small green\" data-v-117637d6>Yes</button></div> <div class=\"col s4\" data-v-117637d6>" + (_vm.is_meter_infraction == 'Yes' ? "<b class=\"green-text\" data-v-117637d6>Yes</b>" : "<!---->") + " " + (_vm.is_meter_infraction == 'No' ? "<b class=\"red-text\" data-v-117637d6>No</b>" : "<!---->") + " " + (_vm.is_meter_infraction == '' ? "<b class=\"red-text\" data-v-117637d6>--</b>" : "<!---->") + "</div> <div class=\"col s4\" data-v-117637d6><button class=\"btn btn-small red\" data-v-117637d6>No</button></div></form></div> <br data-v-117637d6> <div class=\"row\" data-v-117637d6><div class=\"col s12\" data-v-117637d6><input type=\"text\" placeholder=\"Other remarks\"" + _vm._ssrAttr("value", _vm.other_remarks) + " data-v-117637d6></div></div> <br data-v-117637d6> <div class=\"row\" data-v-117637d6><div class=\"col s12\" data-v-117637d6><h6 class=\"red-text\" data-v-117637d6>\n                                Picture of the IDB Box (*)\n                            </h6> <button class=\"btn red btn-large\" data-v-117637d6><i class=\"material-icons white-text\" data-v-117637d6>camera_alt</i></button></div></div> <div class=\"row\" data-v-117637d6><div class=\"col s12\" data-v-117637d6><img id=\"output-pic-of-idb-box\" class=\"responsive-img\" data-v-117637d6></div></div> <div class=\"row\" data-v-117637d6><div class=\"col s12\" data-v-117637d6><h6 class=\"red-text\" data-v-117637d6>\n                                Termination Point (*)\n                            </h6> <button class=\"btn red btn-large\" data-v-117637d6><i class=\"material-icons white-text\" data-v-117637d6>camera_alt</i></button></div></div> <div class=\"row\" data-v-117637d6><div class=\"col s12\" data-v-117637d6><img id=\"output-pic-of-termination-point\" class=\"responsive-img\" data-v-117637d6></div></div> <div class=\"row\" data-v-117637d6><div class=\"col s12\" data-v-117637d6><h6 class=\"red-text\" data-v-117637d6>\n                                Picture of Meter (*)\n                            </h6> <button class=\"btn red btn-large\" data-v-117637d6><i class=\"material-icons white-text\" data-v-117637d6>camera_alt</i></button></div></div> <div class=\"row\" data-v-117637d6><div class=\"col s12\" data-v-117637d6><img id=\"output-pic-of-meter\" class=\"responsive-img\" data-v-117637d6></div></div> <div class=\"row\" data-v-117637d6><div class=\"col s12\" data-v-117637d6><h6 class=\"red-text\" data-v-117637d6>\n                                Picture showing IDB meter No (*)\n                            </h6> <button class=\"btn red btn-large\" data-v-117637d6><i class=\"material-icons white-text\" data-v-117637d6>camera_alt</i></button></div></div> <div class=\"row\" data-v-117637d6><div class=\"col s12\" data-v-117637d6><img id=\"output-pic-of-showing-idb-meter-number\" class=\"responsive-img\" data-v-117637d6></div></div> <div class=\"row center\" data-v-117637d6></div> <div class=\"row center safe-area-bottom\" data-v-117637d6><div class=\"col s12\" data-v-117637d6><button" + _vm._ssrAttr("disabled", _vm.disabled_bool) + " class=\"btn btn-large red\" style=\"width: 300px; margin-top: 20px;\" data-v-117637d6>Submit</button></div></div>")], 2)])])], 2)], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/idb_customer_visitation/index.vue?vue&type=template&id=117637d6&scoped=true
...
var idb_customer_visitationvue_type_script_lang_js = __webpack_require__(61);
  ...
  methods: {
    ...
    async checkNumber() {
      if (this.service_type == 'prepaid') {
        ...
        try {
          const response = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* getIDBCustomerInfoApi */ "j"])(this.meter_number);
          this.account_type = '';
          this.account_name = '';
          this.tarrif = '';
          this.address = '';
    ...
    async doSomethingWithFilesimagePickerForIDBbox(event) {
      ...
      try {
        ...
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "m"])(this.userId, this.meter_number, 'IdbValidation_IdbBox', this.pic_of_idb_box);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
    ...
    async doSomethingWithFilesimagePickerForTerminationPoint(event) {
      ...
      try {
        ...
        // console.log('pic_of_cwd ', this.pic_of_cwd)
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "m"])(this.userId, this.meter_number, 'IdbValidation_TerminationPoint', this.pic_of_termination_point);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
    ...
    async doSomethingWithFilesimagePickerForMeter(event) {
      ...
      try {
        ...
        // console.log('pic_of_cwd ', this.pic_of_cwd)
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "m"])(this.userId, this.meter_number, 'IdbValidation_Meter', this.pic_of_meter);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
    ...
    async doSomethingWithFilesimagePickerForShowingIDBMeterNo(event) {
      ...
      try {
        ...
        // console.log('pic_of_cwd ', this.pic_of_cwd)
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "m"])(this.userId, this.meter_number, 'IdbValidation_ShowingIdbMeterNo', this.pic_showing_idb_meter_no);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
    ...
    async submit() {
      ...
      if (this.business_unit == '') {
        ...
        try {
          ...
          const rawResponse = await fetch('https://api.ikejaelectric.com/cwfrestapi/v1/api/v1/idbvalidation', {
            method: 'POST',
            headers: {
              'Accept': 'application/json',
              'Content-Type': 'application/json',
...
var add = __webpack_require__(4).default
module.exports.__inject__ = function (context) {
  add("76b6768e", content, true, context)
};

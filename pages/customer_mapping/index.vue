            ...
            <div class="col s12">
                <form @submit.prevent style="margin-top: 20px">
                    ...
                    <div class="row">
                        <!-- cutomer name -->
                        <div class="col s12">
                            <input type="text" placeholder="Account meter number" v-model="account_number"> 
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <!-- cutomer name -->
                        <div class="col s12">
                            <input type="text" placeholder="Account type" v-model="account_type"> 
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col s12">
                            <input type="text" v-model="new_dt_nomenclature" placeholder="new_dt_nomenclature">
                        </div>
                    </div>

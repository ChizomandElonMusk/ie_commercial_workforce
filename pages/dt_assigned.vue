<template>
    <div style="padding-top: 20px;" class="container">
        <div class="row">
            <div class="col s12">
                ...
                <b class="grey-text btn disabled">DT Assigned</b>
            </div>
        </div>
        ...
        <div class="row" :class="{'hide': hideForm}">
            <div class="col s12">
                <form @submit.prevent style="margin-top: 20px">
                    ...
                    <div class="row" :class="{'hide': hideLoading}">
                    ...
                    <div class="row" :class="{'hide': hideDTList}">
                        ...
                        <div class="col s12">
                            <table class="striped">
                                ...
                                <tbody v-for="(dt, index) in dtAssignedList" :id="dt.dtNo">
                                    <tr>
                                        <td>
                                        <a href="#!">
                                            {{ dt.dtNo }}
  ...
  import { getAllDTList} from '~/js_modules/mods'

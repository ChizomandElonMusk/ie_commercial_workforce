                ...
                <form @submit.prevent style="margin-top: 20px">
                    ...
                    <div class="row">
                        ...
                        <div class="col s12">
                            ...
                            <button class="btn red btn-large" @click="imagePickerForPictureOfConnection()">
                    ...
                    <div class="row">
                        ...
                        <div class="col s12">
                            ...
                            <button class="btn red btn-large" @click="imagePickerForPictureOfPSF()">
                                <i class="material-icons white-text">camera_alt</i>
                            </button>
                            <!-- <input type="file" accept="image/*" capture="environment" id="pic-of-the-service-wire-from-pole-to-metering-point" /> -->
                        </div>
                    ...
                    <div class="row center">
                        <div class="col s12">
                            <button class="btn btn-large red col s12"  @click="submit()">Submit</button>
                        </div>
                    </div>

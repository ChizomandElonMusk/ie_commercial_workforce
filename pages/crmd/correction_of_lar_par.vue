    ...
    <div style="padding-top: 20px;" class="container">
        <div class="row">
            <div class="col s12">
                ...
                <b class="grey-text btn disabled">Correction of LAR & PAR</b>
            </div>
        </div>
            ...
            <div class="row" :class="{ 'hide': hideForm }">
                <div class="col s12">
                    <form @submit.prevent style="margin-top: 20px">
                        ...
                        <div class="row">
                            <div class="col s12">
                                <img class=" responsive-img" id="output-pic-of-the-PAR" />
                            </div>
                        </div>
                        ...
                        <div class="row center safe-area-bottom">
                            <div class="col s12">
                                <button class="btn btn-large red" style="width: 300px; margin-top:" @click="submit"
    ...
    methods: {
        ...
        async doSomethingWithFilesimagePickerForPAR(event) {
            ...
            try {
                ...
                // hello()
                var xx = await uploadImage(this.userId, this.account_number, 'CorrectionOfLarPar_FrontView', this.pic_of_frontview)
                console.log(xx)
        ...
        async doSomethingWithFilesimagePickerAdditionalPic(event) {
            ...
            try {
                ...
                // console.log('pic_of_cwd ', this.pic_of_cwd)
                // hello()
                var xx = await uploadImage(this.userId, this.account_number, 'CorrectionOfLarPar_Additional', this.pic_of_additional_pic)
                console.log(xx)

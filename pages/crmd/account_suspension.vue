                    ...
                    <form @submit.prevent style="margin-top: 20px">
                        ...
                        <div class="row">
                            ...
                            <div class="col s12">
                                ...
                                <button class="btn red btn-large" @click="imagePickerCWD()">
                        ...
                        <div class="row">
                            <div class="col s12">
                                <img class=" responsive-img" id="output-pic-of-cwd" />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col s12">
                                ...
                                <button class="btn red btn-large" @click="imagePickerFV()">
                                    <i class="material-icons white-text">camera_alt</i>
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col s12">
                                <img class=" responsive-img" id="output-pic-of-FV" />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col s12">
                                ...
                                <button class="btn red btn-large" @click="imagePickerForADOissued()">
                                    <i class="material-icons white-text">camera_alt</i>
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col s12">
                                <img class=" responsive-img" id="output-pic-of-ADO-issued" />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col s12">
                                ...
                                <textarea placeholder="Additional Remarks" class="materialize-textarea"
                                    v-model="additional_remark"></textarea>
                            </div>
                        </div>
    ...
    methods: {
        ...
        async doSomethingWithFilesimagePickerCWD(event) {
            ...
            try {
                ...
                // hello()
                var xx = await uploadImage(this.userId, this.account_number, 'AccountSuspension_WireDown', this.pic_of_cwd)
                console.log(xx)
        ...
        async doSomethingWithFilesimagePickerFV(event) {
            ...
            try {
                ...
                // console.log('pic_of_cwd ', this.pic_of_cwd)
                // hello()
                var xx = await uploadImage(this.userId, this.account_number, 'AccountSuspension_FrontView', this.pic_of_fv)
                console.log(xx)
        ...
        async doSomethingWithFilesimagePickerForADOissued(event) {
            ...
            try {
                ...
                // console.log('pic_of_cwd ', this.pic_of_cwd)
                // hello()
                var xx = await uploadImage(this.userId, this.account_number, 'AccountSuspension_ADOIssued', this.pic_of_ado_issued)
                console.log(xx)
        ...
        async doSomethingWithFilesimagePickerForAdditional(event) {
            ...
            try {
                ...
                // console.log('pic_of_cwd ', this.pic_of_cwd)
                // hello()
                var xx = await uploadImage(this.userId, this.account_number, 'AccountSuspension_Additional', this.pic_of_additional)
                console.log(xx)
        ...
        async submit() {
            ...
            if (this.business_unit == '' || this.remarks == '' || this.remarks == null || this.remarks == 'Reason for suspension *') {
                ...
                M.toast({ html: '<b class="red-text">Please add pic of ADO issued *</b>' })
            } else {

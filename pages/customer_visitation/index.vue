                    ...
                    <form @submit.prevent style="margin-top: 20px">
                            ...
                            <form @submit.prevent>
                                <div class="col s6">
                                    <button class="btn btn-small red"
                                        :class="{ 'green': is_account_mapped_to_correct_dt_green }"
                        ...
                        <div class="row center">
                            ...
                            <form @submit.prevent>
                                <div class="col s6">
                                    <button class="btn btn-small red"
                                        :class="{ 'green': is_customer_phone_no_correct_green }"
                        ...
                        <div class="row center">
                            ...
                            <form @submit.prevent>
                                <div class="col s6">
                                    <button class="btn btn-small red"
                                        :class="{ 'green': is_customer_address_correct_green }"
                        ...
                        <div class="row center">
                            ...
                            <form @submit.prevent>
                                ...
                                <div class="col s6">
                                    <button class="btn btn-small red" @click="isMeterBypassedtNo()"
                                        :class="{ 'green': is_meter_bypassed_green }">No</button>
                                </div>
                            </form>
                        </div>
                        <br>

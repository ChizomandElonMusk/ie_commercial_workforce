            ...
            <div class="col s12">
                <form @submit.prevent style="margin-top: 20px">
                    ...
                    <p>
                        ...
                        <br>
                        <label>
                            <input name="shared_bill_or_meter" type="radio" value="Yes" v-model="shared_bill_or_meter" checked />
                            <span>Yes</span>
                        </label>
                        </p>
                        <p>
                        <label>
                            <input name="shared_bill_or_meter" type="radio" value="No" v-model="shared_bill_or_meter" />
                            <span>No</span>
                        </label>
                    </p>
                    ...
                    <div class="row">
                        <!-- address -->
                        <div class="col s12">
                            <input type="text" v-if="shared_bill_or_meter === 'Yes'" placeholder="How many?" v-model="shared_bill_or_meter_input">
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="row">
                        <!-- address -->
                        <div class="col s12">
                            <input type="text" v-if="user_of_premise === 'Others'" placeholder="How many?" v-model="other_comment">
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="row center">
                        ...
                        <form @submit.prevent>
                            <div class="col s6">
                                <button class="btn btn-small red" :class="{'green': is_account_mapped_to_correct_dt_green}" @click="isAccountMappedToCorrectDTYes()">Yes</button>
                            </div>
                            <div class="col s6">
                                <button class="btn btn-small red" @click="isAccountMappedToCorrectDTNo()">No</button>
                            </div>
                        </form>
                    </div>
                    <br>
                    ...
                    <div class="row center">
                        ...
                        <form @submit.prevent>
                            <div class="col s6">
                                <button class="btn btn-small red" :class="{'green': is_customer_phone_no_correct_green}" @click="isCustomerPhoneNoCorrectYes()">Yes</button>
                            </div>
                            <div class="col s6">
                    ...
                    <div class="row center">
                        ...
                        <form @submit.prevent>
                            <div class="col s6">
                                <button class="btn btn-small red" :class="{'green': is_customer_address_correct_green}" @click="isCustomerAddressCorrectYes()">Yes</button>
                            </div>
                            <div class="col s6">
                    ...
                    <div class="row center">
                        ...
                        <form @submit.prevent>
                            <div class="col s6">
                                <button class="btn btn-small red" @click="isMeterBypassedtYes()">Yes</button>
                            </div>
                            <div class="col s6">
                                <button class="btn btn-small red" @click="isMeterBypassedtNo()"  :class="{'green': is_meter_bypassed_green}">No</button>
                            </div>
                        </form>
                    </div>
                    <br>
                    ...
                    <div class="row center">
                        ...
                        <form @submit.prevent>
                            ...
                            <div class="col s6">
                                <button class="btn btn-small red" @click="customerCompliantNo()"  :class="{'green': customer_complaint_green}">No</button>
                            </div>
                        </form>
                    </div>
                    <br>

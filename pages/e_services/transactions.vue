<template>
    <div style="padding-top: 20px;" class="container">
        <div class="row">
            <div class="col s12">
                ...
                <b class="grey-text btn disabled">Payment history</b>
            </div>
        </div>
                            ...
                            <table class="striped">
                                ...
                                <tbody v-for="(trans, index) in transactionList" :id="trans.orderNo">
                                    <tr>
                                        ...
                                        <td><img src="~assets/images/view.svg" v-on:click="getPaymentRec(trans.orderNo)" class="responsive-img" style="max-width: 30px;" alt=""></td>
                                    </tr>
  ...
  import { getPaymentHistory} from '~/js_modules/mods'
        ...
        async paymentHistory() {
            try {
                ...
                if(this.date_from == '' || this.date_to == '') {
                    ...
                    this.transactionList = await getPaymentHistory(this.meter_number, date_from, date_to)

    ...
    <div style="padding-top: 20px;" class="container">
        <div class="row">
            <div class="col s12">
                ...
                <b class="grey-text btn disabled" style="font-size: 10px;"> Non-Vending Customer Validation</b>
            </div>
        </div>
                    ...
                    <form @submit.prevent style="margin-top: 20px">
                        ...
                        <div class="row">
                            <div class="col s12" style="margin-bottom: 15px;">
                                <CustomSelect
                                    ...
                                    :default="'Validation Outcomes'" class="" v-model="validation_outcomes" />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col s12">
                                ...
                                <button class="btn red btn-large" @click="imagePickerForDiconnection()">
                                    <i class="material-icons white-text">camera_alt</i>
                                </button>
                                <!-- <input type="file" accept="image/*" capture="environment" id="pic-of-the-service-wire-from-pole-to-metering-point" /> -->
                            </div>
                        ...
                        <div class="row">
                            <div class="col s12">
                                <img class=" responsive-img" id="output-pic-of-disconnection" />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col s12">
                                <h6 class="red-text">Additional comments:</h6>
    ...
    methods: {
        ...
        async doSomethingWithFilesimagePickerForMeter(event) {
            ...
            try {
                ...
                // hello()
                var xx = await uploadImage(this.userId, this.account_number, 'NonVendingCustomer_Meters', this.pic_of_meter)
                console.log(xx)
        ...
        async doSomethingWithFilesimagePickerApartment(event) {
            ...
            try {
                ...
                // console.log('pic_of_cwd ', this.pic_of_cwd)
                // hello()
                var xx = await uploadImage(this.userId, this.account_number, 'NonVendingCustomer_Apartment', this.pic_of_apartment)
                console.log(xx)
        ...
        async doSomethingWithFilesimagePickerForDiconnection(event) {
            ...
            try {
                ...
                // console.log('pic_of_cwd ', this.pic_of_cwd)
                // hello()
                var xx = await uploadImage(this.userId, this.account_number, 'NonVendingCustomer_ApartmentDisc', this.pic_of_diconnection)
                console.log(xx)

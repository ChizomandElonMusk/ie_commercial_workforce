<template>
            ...
            <div class="col s12">
                <form @submit.prevent style="margin-top: 20px">
                    ...
                    <div class="row" v-if="service_type == 'prepaid'">
                        ...
                        <div class="col s3">
                            <button class="btn btn-flat red white-text" @click="esrFormHistory()">Check</button>
                        </div>
                    </div> -->
                    ...
                    <div class="row">
                        <div class="col s12">
                            <button class="btn btn-flat red white-text col s12" @click="esrFormHistory()">Check</button>
                        </div>
                    </div>
                    ...
                    <!-- <div class="row" :class="{'hide': hideesrFormHistoryList}"> -->
                    <div class="row" >

                        <div class="col s12">

                            <div class="card red white-text" v-for="(history, index) in esrFormHistoryList" :id="history.trackingId">
                                <div class="card-content white-text">
                                    <!-- <span class="card-title" style="font-weight: 600;">Payment Details</span> -->
                                    <p><b class="yellow-text">ID:</b> <br> {{ history.trackingId }} </p>
                                    <p><b class="yellow-text">Category:</b> <br> {{ history.approvalCategory }} </p>
                                    <p><b class="yellow-text">DT:</b> <br> {{ history.dt }} </p>
                                    <p><b class="yellow-text">Account Type:</b> <br> {{ history.accountType }} </p>
                                    <p><b class="yellow-text">BU:</b> <br> {{ history.bu }} </p>
                                    <p><b class="yellow-text">Address:</b> <br> {{ history.address }} </p>
                                    <p><b class="yellow-text">DT No:</b> <br> {{ history.dtNo }} </p>
                                    <p><b class="yellow-text">Meter No:</b> <br> {{ history.meterNo }} </p>
                                    <p><b class="yellow-text">serviceType:</b> <br> {{ history.serviceType }} </p>
                                </div>
                            </div>
  ...
  import { getEsrFormHistory} from '~/js_modules/mods'
        ...
        async esrFormHistory() {
            ...
            try {
                ...
                if(this.date_from == '' || this.date_to == '') {
                    ...
                    this.esrFormHistoryList = await getEsrFormHistory(date_from, date_to)

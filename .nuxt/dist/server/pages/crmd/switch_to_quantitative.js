...
module.exports.__inject__ = function (context) {
  add("84d6d0da", content, true, context)
};
...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_switch_to_quantitative_vue_vue_type_style_index_0_id_7d9e3612_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(102);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_switch_to_quantitative_vue_vue_type_style_index_0_id_7d9e3612_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_switch_to_quantitative_vue_vue_type_style_index_0_id_7d9e3612_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_switch_to_quantitative_vue_vue_type_style_index_0_id_7d9e3612_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_switch_to_quantitative_vue_vue_type_style_index_0_id_7d9e3612_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, "#sig-canvas[data-v-7d9e3612]{border:2px dotted #ccc;border-radius:15px;cursor:crosshair}", ""]);
// Exports
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/crmd/switch_to_quantitative.vue?vue&type=template&id=7d9e3612&scoped=true&
var render = function render() {
  ...
  }, [_vm._ssrNode("<div class=\"row\" data-v-7d9e3612>", "</div>", [_vm._ssrNode("<div class=\"col s12\" data-v-7d9e3612>", "</div>", [_c('nuxt-link', {
    staticClass: "red white-text btn",
    attrs: {
      "to": "./"
    }
  }, [_vm._v("\n                Back \n            ")]), _vm._ssrNode(" <b class=\"grey-text btn disabled\" data-v-7d9e3612>Switch to Quantitative</b>")], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"row\" data-v-7d9e3612>", "</div>", [_vm._ssrNode("<div class=\"row\" data-v-7d9e3612><div class=\"col s12\" data-v-7d9e3612><div" + _vm._ssrClass("row", {
    'hide': _vm.hideModal
  }) + " data-v-7d9e3612><div class=\"row\" data-v-7d9e3612><a href=\"#!\" class=\"waves-effect waves-red btn-large white red-text right\" data-v-7d9e3612>DONE</a></div> <div class=\"row\" data-v-7d9e3612><div class=\"container\" data-v-7d9e3612><div class=\"row\" data-v-7d9e3612><div class=\"col s12 center\" data-v-7d9e3612><h6 data-v-7d9e3612>Sign here!</h6></div></div> <div class=\"row\" data-v-7d9e3612><div class=\"col s12 center\" data-v-7d9e3612><canvas id=\"sig-canvas\" width=\"250px\" data-v-7d9e3612>\n                                    Your phone not supporting signature\n                                </canvas></div></div> <div class=\"row\" data-v-7d9e3612><div class=\"col s12 center\" data-v-7d9e3612><div class=\"col s6\" data-v-7d9e3612><button id=\"sig-submitBtn\" class=\"btn btn-large red\" data-v-7d9e3612>Save</button></div> <div class=\"col s6\" data-v-7d9e3612><button id=\"sig-clearBtn\" class=\"btn btn-large red\" data-v-7d9e3612>Clear</button></div></div></div> <br data-v-7d9e3612> <div class=\"row\" data-v-7d9e3612><div class=\"col s12\" data-v-7d9e3612><textarea id=\"sig-dataUrl\" rows=\"5\" class=\"form-control hide\" data-v-7d9e3612>Data URL for your signature will go here!</textarea></div></div></div></div></div></div></div> "), _vm._ssrNode("<div" + _vm._ssrClass("row", {
    'hide': _vm.hideForm
  }) + " data-v-7d9e3612>", "</div>", [_vm._ssrNode("<div class=\"col s12\" data-v-7d9e3612>", "</div>", [_vm._ssrNode("<form style=\"margin-top: 20px\" data-v-7d9e3612>", "</form>", [_vm._ssrNode("<div class=\"row\" data-v-7d9e3612>", "</div>", [_vm._ssrNode("<div class=\"col s12\" style=\"margin-bottom: 15px;\" data-v-7d9e3612>", "</div>", [_c('CustomSelect', {
    attrs: {
  ...
  })], 1)]), _vm._ssrNode(" " + (_vm.service_type == 'postpaid' ? "<div class=\"row\" data-v-7d9e3612><div class=\"col s9\" data-v-7d9e3612><input type=\"text\" placeholder=\"Account number\"" + _vm._ssrAttr("value", _vm.account_number) + " data-v-7d9e3612></div> <div class=\"col s3\" data-v-7d9e3612><button class=\"btn btn-flat red white-text\" data-v-7d9e3612>Check</button></div></div>" : "<!---->") + " " + (_vm.service_type == 'prepaid' ? "<div class=\"row\" data-v-7d9e3612><div class=\"col s9\" data-v-7d9e3612><input type=\"text\" placeholder=\"Meter number\"" + _vm._ssrAttr("value", _vm.meter_number) + " data-v-7d9e3612></div> <div class=\"col s3\" data-v-7d9e3612><button class=\"btn btn-flat red white-text\" data-v-7d9e3612>Check</button></div></div>" : "<!---->") + " <div class=\"row\" data-v-7d9e3612><div class=\"col s12\" data-v-7d9e3612><input type=\"text\" placeholder=\"Account name\" disabled=\"disabled\"" + _vm._ssrAttr("value", _vm.account_name) + " data-v-7d9e3612></div></div> <div class=\"row\" data-v-7d9e3612><div class=\"col s12\" data-v-7d9e3612><input type=\"text\" placeholder=\"Tarrif\" disabled=\"disabled\"" + _vm._ssrAttr("value", _vm.tarrif) + " data-v-7d9e3612></div></div> <div class=\"row\" data-v-7d9e3612><div class=\"col s12\" data-v-7d9e3612><input type=\"text\" placeholder=\"Address\" disabled=\"disabled\"" + _vm._ssrAttr("value", _vm.address) + " data-v-7d9e3612></div></div> <div class=\"row\" data-v-7d9e3612><div class=\"col s12\" data-v-7d9e3612><b data-v-7d9e3612>BU:</b>" + _vm._ssrEscape(" " + _vm._s(_vm.business_unit) + "\n                        ") + "</div></div> <br data-v-7d9e3612> <div class=\"row\" data-v-7d9e3612><div class=\"col s12\" data-v-7d9e3612><b data-v-7d9e3612>UT:</b>" + _vm._ssrEscape(" " + _vm._s(_vm.undertaking_one) + "\n                        ") + "</div></div> <div class=\"row\" data-v-7d9e3612><div class=\"col s12\" data-v-7d9e3612><input type=\"text\" placeholder=\"DT name\" disabled=\"disabled\"" + _vm._ssrAttr("value", _vm.dt_name) + " data-v-7d9e3612></div></div> <div class=\"row\" data-v-7d9e3612><div class=\"col s12\" data-v-7d9e3612><input type=\"text\" placeholder=\"Account status\" disabled=\"disabled\"" + _vm._ssrAttr("value", _vm.account_status) + " data-v-7d9e3612></div></div> <div class=\"row\" data-v-7d9e3612><div class=\"col s12\" data-v-7d9e3612><input type=\"text\" placeholder=\"Phone number\" disabled=\"disabled\"" + _vm._ssrAttr("value", _vm.phone_number) + " data-v-7d9e3612></div></div> <div class=\"row\" data-v-7d9e3612><div class=\"col s12\" data-v-7d9e3612><input type=\"text\" placeholder=\"Location\" disabled=\"disabled\"" + _vm._ssrAttr("value", _vm.location) + " data-v-7d9e3612></div></div> <div class=\"row\" data-v-7d9e3612><div class=\"col s12\" data-v-7d9e3612><h6 class=\"red-text\" data-v-7d9e3612>\n                            Picture of faulty/burnt/non-existent meter\n                        </h6> <button class=\"btn red btn-large\" data-v-7d9e3612><i class=\"material-icons white-text\" data-v-7d9e3612>camera_alt</i></button></div></div> <div class=\"row\" data-v-7d9e3612><div class=\"col s12\" data-v-7d9e3612><img id=\"output-pic-of-fbnm\" class=\"responsive-img\" data-v-7d9e3612></div></div> <div class=\"row\" data-v-7d9e3612><div class=\"col s12\" data-v-7d9e3612><h6 class=\"red-text\" data-v-7d9e3612>\n                            Picture of MobiForm\n                        </h6> <button class=\"btn red btn-large\" data-v-7d9e3612><i class=\"material-icons white-text\" data-v-7d9e3612>camera_alt</i></button></div></div> <div class=\"row\" data-v-7d9e3612><div class=\"col s12\" data-v-7d9e3612><img id=\"output-pic-of-additional-pic1\" class=\"responsive-img\" data-v-7d9e3612></div></div> <div class=\"row\" data-v-7d9e3612><div class=\"col s12\" data-v-7d9e3612><h6 class=\"red-text\" data-v-7d9e3612>\n                            Additional pic 2\n                        </h6> <button class=\"btn red btn-large\" data-v-7d9e3612><i class=\"material-icons white-text\" data-v-7d9e3612>camera_alt</i></button></div></div> <div class=\"row\" data-v-7d9e3612><div class=\"col s12\" data-v-7d9e3612><img id=\"output-pic-of-additional-pic2\" class=\"responsive-img\" data-v-7d9e3612></div></div> <div class=\"row\" data-v-7d9e3612><div class=\"col s12\" data-v-7d9e3612><h6 class=\"red-text\" data-v-7d9e3612>Remarks:</h6> <textarea placeholder=\"Remarks\" class=\"materialize-textarea\" data-v-7d9e3612>" + _vm._ssrEscape(_vm._s(_vm.remarks)) + "</textarea></div></div> <div class=\"row center\" data-v-7d9e3612></div> <div class=\"row center\" data-v-7d9e3612><div class=\"col s12\" data-v-7d9e3612><button class=\"btn btn-large red\" style=\"width: 300px; margin-top: 20px; margin-bottom: 20px;\" data-v-7d9e3612>Submit</button></div></div>")], 2)])])], 2)], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/crmd/switch_to_quantitative.vue?vue&type=template&id=7d9e3612&scoped=true&
  ...
  methods: {
    ...
    async doSomethingWithFilesimagePickerForFBNM(event) {
      ...
      try {
        ...
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_4__[/* uploadImage */ "i"])(this.userId, this.account_number, 'SwitchToQuantitative_Faulty', this.pic_of_fbnm);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
    ...
    async doSomethingWithFilesimagePickerAdditionalPic1(event) {
      ...
      try {
        ...
        // console.log('pic_of_cwd ', this.pic_of_cwd)
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_4__[/* uploadImage */ "i"])(this.userId, this.account_number, 'SwitchToQuantitative_Additional', this.additional_pic1);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
    ...
    async doSomethingWithFilesimagePickerAdditionalPic2(event) {
      ...
      try {
        ...
        // console.log('pic_of_cwd ', this.pic_of_cwd)
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_4__[/* uploadImage */ "i"])(this.userId, this.account_number, 'SwitchToQuantitative_Additional1', this.additional_pic2);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
